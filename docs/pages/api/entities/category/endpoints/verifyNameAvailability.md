# GET /api/categories/category-name-exists/:categoryName/:id

## Descripción

Este endpoint permite verificar si un nombre se encuentra disponible antes de crear o modificar una categoría.
...
```
GET /api/categories/category-name-exists/Deportivo Compacto/-1
