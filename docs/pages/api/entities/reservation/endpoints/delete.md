...
Este endpoint permite eliminar una reserva, a partir de su identificador.
...
- #### 400 Bad Request
  ...
  - Restricción de integridad:
    ...
    - Respuesta:
      ...
      ```
      {
          "message": "La reserva no se puede eliminar porque ya se ha enviado un recordatorio al cliente."
      }
      ```
