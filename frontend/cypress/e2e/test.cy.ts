// Tener abierto el cypress.config.ts para que no marque errores

describe('Test End-to-End (E2E)', () => {
  it('Debería permitir completar el flujo principal de la aplicación', () => {
    ...
    cy.get('[formControlName="categoryDescription"]').type(
    ...
    cy.get('mat-select[formControlName="transmissionType"]').click({
      force: true,
    });
    ...
    cy.get('[formControlName="manufacturingYear"]').type('2025', {
      force: true,
    });
